...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    const Data = localStorage.getItem('wFMS');
    ...
    const fetchData = () => {
      ...
      fetch(url)
        ...
        .then(data => {
          ...
          localStorage.setItem("wFMS", JSON.stringify(FirstTeam));
...

{
                Fulldata1.length > 0 && Fulldata1[1] && (
                  <>
                    ...
                    {/* //static */}
                    <div className="text-[36rem] inset-0 absolute -left-4 -top-28  font-custom text-custom">
                        CHAMPION
                    </div>
