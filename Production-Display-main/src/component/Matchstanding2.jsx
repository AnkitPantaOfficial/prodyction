...
export default function Matchstanding2() {
    ...
    useEffect(() => {
        const Data = localStorage.getItem('RMS2');
        const Data1 = localStorage.getItem('FMS2');
        const Data2 = localStorage.getItem('MatchS1');
                    ...
                    if (activeMatch) {
                        ...
                        fetch(activeMatch.URL)
                            ...
                            .then(data => {
                                ...
                                let RestTeam = formattedData.Teams.slice(13)
                                console.log(FirstTeam, "first")
                                console.log(RestTeam, "rest")
                                setFirst(FirstTeam);
                                setRest(RestTeam);
                                localStorage.setItem("FMS2", JSON.stringify(FirstTeam));
                                localStorage.setItem("RMS2", JSON.stringify(RestTeam));
                            })
                            .catch((error) => {
