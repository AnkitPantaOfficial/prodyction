...
export default function Runnerup() {
  ...
  useEffect(() => {
    ...
    const Data = localStorage.getItem('runFMS');
                ...
                <div >
                  ...
                  <div className='flex flex-col relative -top-[10.75rem] justify-center items-center' >
                    <div className='flex justify-around  w-[1773px]'>
                      <div className='flex justify-evenly tracking-[0.1em] items-center w-[727px] h-[63px]  relative z-50 bg-[#e89049]' style={{ clipPath: " polygon(682.1px 0px, 0px 0px, 40.9px 62px, 718px 62px)" }} >
                        <h2 className=' font-custom  text-[61px] font-bold text-white' >{First.TeamName}</h2>
                        <img width="100px" src={First.TeamLogo} alt="" />
                      </div>
                      <div className='flex justify-center items-center w-[451px] h-[63px] relative  z-50 bg-[#e89049]' style={{ clipPath: " polygon(91% 0%, 0% 0%, 5.71% 100%, 100.11% 100%)" }} >
